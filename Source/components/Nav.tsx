...
const Nav = () => {
    ...
    return (
        <div className="w-full fixed top-0 z-50">
            ...
            {toggleDropdown && (
                <div className="gap-4 mt-[0.5] p-6 w-full flex flex-col justify-start items-start bg-primary-nav-blue text-white text-2xl sm:hidden">
                    <span
                        className="mx-6 dropdown_link w-full cursor-pointer"
                        onClick={() => scrollToSection("about")}
                    >
                        ABOUT ME
                    </span>
