        ...
        <div className="absolute z-50">
            <nav className="fixed top-0 left-0 w-screen pt-3 py-4 flex flex-col bg-primary-nav-blue text-white">
                ...
                >
                    ...
                    {/* Desktop Navigation */}
                    <div className="px-4 hidden sm:flex gap-3 md:gap-5">
                        <span
                            className="dropdown_link whitespace-nowrap cursor-pointer"
                ...
                {toggleDropdown && (
                    <div className="flex flex-col gap-4 mt-[0.5] py-6 bg-primary-nav-blue text-white text-2xl sm:hidden border-t-[1px] border-t-white">
                        <span
                            className="mx-4 dropdown_link cursor-pointer"
                            onClick={() => scrollToSection("about")}
                        >
                            ABOUT ME
                        </span>
